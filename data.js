...
// ─────────── Anthropic ───────────
{
  ...
  lastVerified: "2026-04-24",
  tokenizer: "claude",
  tags: ["balanced", "recommended-default"]
}, {
  id: "haiku-4-5",
  provider: "Anthropic",
...
// ─────────── Google ───────────
{
  ...
  lastVerified: "2026-04-24",
  tokenizer: "gemini",
  tags: ["2M-context", "context-tiered"],
...
function effectivePrices(model, inputTokens) {
  if (model.longCtxThreshold && inputTokens > model.longCtxThreshold) {
    return {
      ...
      // cache rate isn't typically tiered
      tiered: true
    };
  }
  return {
...
function fmtUSD(n, decimals = 4) {
  ...
  if (abs >= 10) return "$" + n.toLocaleString("en-US", {
