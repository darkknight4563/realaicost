    ...
    <>
      ...
      <header className="topbar">
        ...
        <div className="topbar-links">
          ...
          <button className="icon-btn" aria-label="Toggle dark mode" onClick={() => tweaks.setKeys({ theme: tweaks.values.theme === "dark" ? "light" : "dark" })} title="Toggle theme">
        ...
        <div className="calc-grid">
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
            ...
            <div className="share-bar">
              ...
              <input className="share-url" aria-label="Shareable calculation URL" value={location.href} readOnly onFocus={e => e.target.select()}/>
